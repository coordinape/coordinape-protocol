...
def test_migration(mock_ape_reg, mock_ape_fee, mock_ape_distro, mock_ape_router, mock_ape_factory, mock_yearn_vault_factories, ApeVaultWrapper, MockVault, minter, MockToken, mock_yearn_reg, interface):
